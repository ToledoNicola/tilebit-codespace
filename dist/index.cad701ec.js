...
})({"9TvMH":[function(require,module,exports) {
...
function isPaidSubscritionActive() {
    ...
    if (paddleSubscription.state == "active") return true;
    if (paddleSubscription.state == "paused") return false;
}
...
},{}]},["9TvMH","Y4A21"], "Y4A21", "parcelRequireb588")
